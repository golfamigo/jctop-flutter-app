              ...
              children: [
                Text(
                  FFLocalizations.of(context).getText(
                    'bwibal0o' /* Allow EVENTY to use your locat... */,
                  ),
                ...
                Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'tlcrhra3' /* We will use your location to s... */,
                    ),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          _model.city =
                              await actions.getCityNameOrCoordsDebug();
                          if (_model.city != null && _model.city != '') {
                            FFAppState().selectedCountry = _model.city!;
                          } else {
                          ...
                          Navigator.pop(context, FFAppState().selectedCountry);
