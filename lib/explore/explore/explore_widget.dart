                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'eoapumc1' /* Discover live shows, festivals... */,
                                  ),
                        ...
                        builder: (context) {
                          ...
                          return Wrap(
                            ...
                            children: List.generate(popularSearches.length,
                                (popularSearchesIndex) {
                              final popularSearchesItem =
                                  popularSearches[popularSearchesIndex];
                              return Container(
                                decoration: BoxDecoration(
                                  color: FlutterFlowTheme.of(context)
                                      .secondaryBackground,
                            ...
                            children: List.generate(categoriesList.length,
                              ...
                              return InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  context
                                      .pushNamed(ExploreSearchWidget.routeName);
                                },
                                child: wrapWithModel(
                                  model: _model.widgetCategoriesCard2Models
                                      .getModel(
                                    categoriesListIndex.toString(),
                                    categoriesListIndex,
                                  ),
                                  updateCallback: () => safeSetState(() {}),
                                  child: WidgetCategoriesCard2Widget(
                                    key: Key(
                                      'Keyxvo_${categoriesListIndex.toString()}',
                                    ),
