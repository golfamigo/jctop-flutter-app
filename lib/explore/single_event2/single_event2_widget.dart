...
class SingleEvent2Widget extends StatefulWidget {
  const SingleEvent2Widget({
    super.key,
    this.data,
  });
  ...
  static String routeName = 'SingleEvent2';
  static String routePath = '/singleEvent2';

  @override
  State<SingleEvent2Widget> createState() => _SingleEvent2WidgetState();
}

class _SingleEvent2WidgetState extends State<SingleEvent2Widget> {
  late SingleEvent2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SingleEvent2Model());
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                '8crh8s47' /* 📅 Date: Sunday & Thursdays (s... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .titleSmall
                                  .override(
                              ...
                              itemBuilder: (context, commentsIndex) {
                                ...
                                return wrapWithModel(
                                  ...
                                  child: WidgetCommentCardWidget(
                                    key: Key(
                                      'Key570_${commentsIndex.toString()}',
                                    ),
                                    data: commentsItem,
                                  ),
                                );
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'pgjikgsm' /* Hurry Up! Tickets Are Selling ... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .titleSmall
                                            .override(
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            '665pmbxd' /* Tickets are in high demand and... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'dl21dxeb' /* Bayfront Park, Miami, FL */,
                        ),
                                ...
                                itemBuilder: (context, eventsListIndex) {
                                  ...
                                  return wrapWithModel(
                                    ...
                                    child: WidgetEventCard2Widget(
                                      key: Key(
                                        'Keyzm2_${eventsListIndex.toString()}',
                                      ),
                                      data: eventsListItem,
                                    ),
                                  );
