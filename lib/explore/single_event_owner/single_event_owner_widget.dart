...
import 'single_event_owner_model.dart';
export 'single_event_owner_model.dart';

class SingleEventOwnerWidget extends StatefulWidget {
  const SingleEventOwnerWidget({super.key});

  static String routeName = 'SingleEventOwner';
  static String routePath = '/singleEventOwner';

  @override
  State<SingleEventOwnerWidget> createState() => _SingleEventOwnerWidgetState();
}

class _SingleEventOwnerWidgetState extends State<SingleEventOwnerWidget> {
  late SingleEventOwnerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SingleEventOwnerModel());
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          fit: BoxFit.cover,
                          image: Image.network(
                            'https://images.unsplash.com/photo-1522601157550-4282ae97472d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHx1bHRyYSUyMG11c2ljJTIwZmVzdGl2YWx8ZW58MHx8fHwxNzM3NDUxNjU3fDA&ixlib=rb-4.0.3&q=80&w=1080',
                          ).image,
                        ),
                      ),
                    ),
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'h6kvj2ft' /* Ultra Events is the driving fo... */,
                          ),
                          style:
