...
abstract class FFAppConstants {
  ...
  static const List<String> RescheduleReasons = [
    ...
    'I have an essential commitment',
    'I don\'t want to tell',
    'Other'
  ];
  static const List<String> CancelAppointment = [
  ...
  static const List<String> ReportEvent = [
  ...
  static const List<String> Lostitems = [
    'Left item in the car',
    'Forgot belongings at the event venue',
    'Dropped the item during travel',
    'Lost while transferring luggage',
    'Misplaced clothing in the changing area',
    'Left valuables at a restaurant or café',
    'Accidentally left in public transportation'
  ];
