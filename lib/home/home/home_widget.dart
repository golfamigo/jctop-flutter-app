                                    ...
                                    return InkWell(
                                      ...
                                      child: wrapWithModel(
                                        ...
                                        child: WidgetCategoriesCard2Widget(
                                          key: Key(
                                            'Keyhki_${categoriesListIndex.toString()}',
                                          ),
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'mtrn5fb5' /* Just Announced. Updated every ... */,
                                                ),
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .labelMedium
                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'lwpb52ts' /* Find Your Next Great Experienc... */,
                                    ),
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'edkcp20m' /* Swipe through a world of excit... */,
                                    ),
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .titleSmall
