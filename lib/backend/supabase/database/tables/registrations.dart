...
class RegistrationsTable extends SupabaseTable<RegistrationsRow> {
  @override
  String get tableName => 'registrations';

  @override
  RegistrationsRow createRow(Map<String, dynamic> data) =>
      RegistrationsRow(data);
}

class RegistrationsRow extends SupabaseDataRow {
  RegistrationsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => RegistrationsTable();
