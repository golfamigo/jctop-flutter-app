...
class TicketDetailsStruct extends BaseStruct {
  TicketDetailsStruct({
    String? ticketTypeId,
  ...
  static TicketDetailsStruct fromMap(Map<String, dynamic> data) =>
      TicketDetailsStruct(
  ...
  static TicketDetailsStruct? maybeFromMap(dynamic data) => data is Map
      ? TicketDetailsStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static TicketDetailsStruct fromSerializableMap(Map<String, dynamic> data) =>
      TicketDetailsStruct(
  ...
  @override
  String toString() => 'TicketDetailsStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is TicketDetailsStruct &&
...
TicketDetailsStruct createTicketDetailsStruct({
  String? ticketTypeId,
  String? ticketTypeName,
  int? quantity,
  int? unitPrice,
