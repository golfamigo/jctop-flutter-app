...
import 'reschedule2_model.dart';
export 'reschedule2_model.dart';

class Reschedule2Widget extends StatefulWidget {
  const Reschedule2Widget({super.key});

  static String routeName = 'Reschedule2';
  static String routePath = '/reschedule2';

  @override
  State<Reschedule2Widget> createState() => _Reschedule2WidgetState();
}

class _Reschedule2WidgetState extends State<Reschedule2Widget> {
  late Reschedule2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Reschedule2Model());
        ...
        appBar: AppBar(
          ...
          title: Text(
            FFLocalizations.of(context).getText(
              'z90e1c5b' /* Reschedule Appointmens */,
            ),
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'onh9gmzb' /* Select your date and session */,
                        ),
