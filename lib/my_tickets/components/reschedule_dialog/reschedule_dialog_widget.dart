...
import 'reschedule_dialog_model.dart';
export 'reschedule_dialog_model.dart';
...
class _RescheduleDialogWidgetState extends State<RescheduleDialogWidget> {
  late RescheduleDialogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RescheduleDialogModel());
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'ugfoxvqw' /* Are you sure you want to resch... */,
                    ),
