        ...
        body: Column(
          ...
          children: [
            ...
            InkWell(
              ...
              highlightColor: Colors.transparent,
              onTap: () async {
                context.pushNamed(HelpCenterSupportWidget.routeName);
              },
              child: Row(
                mainAxisSize: MainAxisSize.max,
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
            ...
            InkWell(
              ...
              highlightColor: Colors.transparent,
              onTap: () async {
                context.pushNamed(HelpCenterPrivacyWidget.routeName);
              },
              child: Row(
                mainAxisSize: MainAxisSize.max,
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
            ...
            InkWell(
              ...
              highlightColor: Colors.transparent,
              onTap: () async {
                context.pushNamed(HelpCenterTermsWidget.routeName);
              },
              child: Row(
                mainAxisSize: MainAxisSize.max,
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'vyif43wp' /* Partnership with Eventy */,
                    ),
                    style: FlutterFlowTheme.of(context).titleSmall.override(
                          font: GoogleFonts.rubik(
                            fontWeight: FlutterFlowTheme.of(context)
