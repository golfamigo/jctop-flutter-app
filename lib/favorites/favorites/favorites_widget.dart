                      ...
                      child: Builder(
                        builder: (context) {
                          ...
                          return ListView.separated(
                            ...
                            itemCount: favoritesCard.length,
                            separatorBuilder: (_, __) => SizedBox(height: 25.0),
                            itemBuilder: (context, favoritesCardIndex) {
                              final favoritesCardItem =
                                  favoritesCard[favoritesCardIndex];
                              return Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    15.0, 0.0, 15.0, 0.0),
                                child: wrapWithModel(
                                  model: _model.widgetEventCardModels.getModel(
                                    favoritesCardIndex.toString(),
                                    favoritesCardIndex,
                                  ),
                                  ...
                                  child: WidgetEventCardWidget(
                                    key: Key(
                                      'Keybdh_${favoritesCardIndex.toString()}',
                                    ),
                                    data: favoritesCardItem,
                                  ),
                                ),
                              );
                            },
